...
$users = [
    ...
    ['name' => 'Николай', 'age' => 77, 'profession' => 'профессиональный игрок в DotA']
];


// 6. Добавьте в массив $users еще одного участника: Виталий, 30 лет, программист
$users[] = ['name' => 'Виталий', 'age' => 30, 'profession' => 'программист'];
...
$mysteriousUser = ['name' => $users[2]['name'], 'age' => $users[0]['age'], 'profession' => $users[1]['profession']];
